...
2025年9月23日、NoPixelは次世代版「NoPixel V」を発表し、これがRockstar Gamesとの直接協業によって開発されていることを明らかにした。従来のように外部アプリのFiveMクライアントを別途インストールしなくても、Rockstar Games Launcherなどから直接サーバーに入れるようになる、この種としては初の公式提携である。Rockstar側も公式アカウントでNoPixelチームへの支援を表明した。
