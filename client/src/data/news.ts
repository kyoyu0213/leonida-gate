...
export type NewsCategory = "official" | "leak" | "analysis";
...
// カテゴリごとの表示設定（ラベル・色・ステータス・フィルタアイコン）
export const CATEGORY_CONFIG: Record<
  NewsCategory,
  { label: string; color: "primary" | "secondary" | "accent"; status: string; filterIcon: string }
> = {
  official: { label: "公式発表", color: "primary", status: "ACTIVE", filterIcon: "📢" },
  leak: { label: "リーク情報", color: "secondary", status: "PROCESSING", filterIcon: "🔓" },
  analysis: { label: "考察", color: "accent", status: "INCOMING", filterIcon: "🔍" },
};

// 一覧フィルタの選択肢（「すべて」＋各カテゴリ）
export const CATEGORIES: { id: NewsCategory | "all"; label: string; icon: string }[] = [
  { id: "all", label: "すべて", icon: "◆" },
  { id: "official", label: CATEGORY_CONFIG.official.label, icon: CATEGORY_CONFIG.official.filterIcon },
  { id: "leak", label: CATEGORY_CONFIG.leak.label, icon: CATEGORY_CONFIG.leak.filterIcon },
  { id: "analysis", label: CATEGORY_CONFIG.analysis.label, icon: CATEGORY_CONFIG.analysis.filterIcon },
];
