...
ここで、LEONIDA GATEが追って調査したところ、2026年5月に入ってさらに新しい動きが確認できた。
...
*※本記事のうち、体型変化システム、髪・ヒゲの成長、ネイルや汗などの細部、衣装保存などに関する記述は、過去作の実績・2022年流出映像・コミュニティの考察に基づく推測を含みます。Rockstar Gamesによる公式発表ではありません。トレーラーで確認できる服・アクセサリーのバリエーションや物理挙動、本編発売日（2026年11月19日／PS5・Xbox Series X|S）は、公式素材・公式発表に基づきます。*`,
  ...
  {
    id: 10,
    title: "GTA6のプレオーダー（予約購入）はいつから？6月25日開始が公式発表、価格は当日判明へ",
    description:
      "予約開始日が6月25日に確定。発売11月19日は変わらず、価格・エディションは当日判明へ。確定情報と未確定の観測を切り分ける。",
    icon: "🛒",
    image: "/images/news/pureo-da-haitukara.png",
    category: "release",
    date: "2026-06-22",
    source: "Rockstar Games Official ／ 各種報道",
    sourceUrl: "https://www.rockstargames.com",
    relatedArticles: [2, 1, 14],
    fullContent: `# GTA6のプレオーダー（予約購入）はいつから？6月25日開始が公式発表、価格は当日判明へ

長らく不明だったGTA6（グランド・セフト・オートVI）の予約購入開始日が、ついに公式に確定した。Rockstar Gamesは2026年6月18日、プレオーダーを6月25日に開始すると正式に発表し、同時に初の公式カバーアートを公開した。一方で価格やエディション構成は発表当日に持ち越されており、6月25日が予約解禁と価格判明の両方を兼ねる節目になる見通しだ。

本記事は2026年6月22日時点の情報をもとに、確定している事実と、まだ確定していない観測・推測をはっきり切り分けて整理する。

---

## 確定している事実（公式発表ベース）

Rockstar Gamesの公式発表およびニュースワイヤーで確認できる確定情報は次のとおり。

- プレオーダー開始日は2026年6月25日。
- 発表は6月18日、Rockstar公式Xおよびニュースワイヤーで告知され、初の公式カバーアートが同時に公開された。
- 予約はデジタルストア（PlayStation Store、Xbox Store）と一部の小売店で受け付ける。
- 対象プラットフォームはPlayStation 5とXbox Series X|Sのみ。PC版はこの予約サイクルに含まれておらず、発売時期も未発表。
- 発売日は2026年11月19日で変更なし。
- 価格についてもRockstarは「予約開始時に明らかになる」と告知しており、6月25日に正式な金額が判明する見込み。

この発表時点では、価格・各エディションの内容・予約特典・早期アクセスといった詳細は一切公式に示されていない。6月19日時点でRockstar公式ページ、PlayStation Store、Xboxページのいずれにも公開価格は掲載されていなかった。

---

## プレオーダー開始が持つ意味

予約解禁は単なる販売スケジュール以上の意味を持つ。

第一に、発売日11月19日が動かない裏付けになる。家庭用ゲームのデジタルストアは、原則として発売まで12か月以内にならないと予約を受け付けない仕組みになっている。この時点で予約が解禁されること自体が、2026年内発売がほぼ固まったことを示すサインと受け止められている。GTA6は過去に二度延期されており（当初2025年秋→2026年5月26日→2026年11月19日）、延期への警戒感が残っていただけに、予約開始は読者にとって安心材料になりやすい。

第二に、市場の反応にも表れた。予約開始の発表を受けてTake-Two Interactiveの株価は約5%上昇したと報じられている。発売そのものに加え、予約の動きがマーケティング規模や物理エディションの生産数、オンラインのサーバー増強計画を左右する重要なデータになるためだ。

第三に、トレーラー第3弾との関係が注目されている。Take-TwoのCEOストラウス・ゼルニック氏は、GTA6のマーケティングは夏に本格化し、第3弾トレーラーは予約開始後になるとの趣旨を述べていた。このため6月25日前後の第3弾公開を予想する声があるが、Rockstarからの確定告知はなく、現時点では未確定の見通しにとどまる。

---

## 価格はいくらになるのか（※未確定の観測）

ここからは公式発表ではなく、業界関係者の発言や過去の前例にもとづく観測である。確定情報と混同しないよう注意したい。

スタンダード版については、Take-TwoのCEOゼルニック氏が70〜80ドルのレンジに収まる可能性を示唆していた。これは現行世代AAAタイトルの標準的な価格帯と一致する。上位版については、GTA Online向けのゲーム内通貨や特典をまとめた100ドル前後のエディションが想定されている。さらに物理的なグッズを同梱するコレクターズ版が用意される場合、過去のRockstar作品の例から150ドルを超える可能性も指摘されている。

一方で、ネット上で拡散した「基本価格が150ドル」「200ドル」といった噂は、複数の報道で否定されている。標準価格は据え置き水準にとどまるという見方が大勢だ。Take-Twoはゲーム内広告を導入しない方針を示しており、価格面でも過度に強気にはならないとの姿勢を示唆している。

小売店側ではすでに、欧州で99ユーロ前後、英国で69〜86ポンドといった仮の価格表示が見られるが、これらはいずれもプレースホルダー（暫定表示）であり、6月25日までは未確認として扱うべき数字である。

---

## エディション構成の予想（※未確定）

エディションの区分についても、6月25日まではすべて推測の域を出ない。

過去のGTA Vやレッド・デッド・リデンプション2の前例から予想される一般的な構成は、基本ゲームを収録するスタンダード版、ゲーム内通貨や特典を加えた上位のデジタル版（デラックス／スペシャル系）、そしてグッズを同梱する物理コレクターズ版という階層型である。

観測筋の一部では、スタンダード／スペシャル／アルティメット／コレクターズの4階層になるという予想も流れている。これらの想定では、スペシャルが追加コスメ（衣装・武器・アクセサリー）、アルティメットがオンライン向けのスターターパック（ゲーム内資金・限定車両・武器・衣装）を上乗せする位置づけとされる。ただしこの4階層構成も、Rockstarが公式に確定したものではなく、過去作のパターンから組み立てた推測にすぎない点に留意が必要だ。

---

## 誤情報・フェイクへの注意

GTA6は発売前で注目度が極めて高いため、確定情報を装った誤った記事や、予約解禁に便乗した詐欺が出回りやすい。LEONIDA GATEが各所の報道を確認したところ、実際に次のような問題が見られた。

- 「Rockstarが4つのエディションと価格（70／90／100／150ドル）を確定発表した」と報じるサイトが存在するが、公式ソースおよび独立した複数メディアの確認（6月19日時点）と矛盾しており、確定情報ではない。価格・エディションの正式発表はあくまで6月25日とされている。
- 発売日を「2024年10月」、PC版を同時発売などと記載する記事も見つかったが、これらは事実と異なる古い情報、もしくは自動生成とみられる内容で、信頼できない。
- 予約解禁前から金銭を要求するサイトや、公式ストア以外への入力を促すリンクには詐欺のリスクがある。予約はPlayStation StoreやXbox Storeなどの公式ストア、および正規の小売店からのみ行うべきである。

要するに、6月25日より前に出回っている価格やエディションの「断定」は、出所が公式でない限りすべて未確認として扱うのが安全だ。

---

## 予約前にしておける準備

確定情報の範囲で、解禁日に慌てないための準備は次のとおり。

- ウィッシュリスト登録：PlayStation StoreまたはMicrosoft Storeで「Grand Theft Auto VI」をウィッシュリストに追加しておくと、予約開始時に通知を受け取れる。
- ウォレットへの事前チャージ：デジタル版を予約する場合、あらかじめ残高を入れておくと購入手続きがスムーズになる。
- デジタル版か物理版かの選択：デジタル版は発売時のプリロードに対応する一方、物理コレクターズ版は数量限定で早期に売り切れる可能性がある。物理の限定版を狙う場合は解禁初日の行動が安全とされる。

---

## まとめ：確定と未確定の切り分け

現時点で確定しているのは、「2026年6月25日にPS5・Xbox Series X|S向けの予約が始まる」「発売は11月19日」「価格も6月25日に判明する見込み」という公式情報である。

一方で、具体的な価格・エディション構成・予約特典・トレーラー第3弾の公開日は、いずれもまだ公式に確定していない。70〜80ドル説や4階層エディション説は、あくまで業界関係者の発言や過去作の前例にもとづく観測であり、6月25日のRockstar公式発表を待って初めて確定する。

GTA6は未発売タイトルであり、価格やエディションを「すでに確定済み」と断定する情報には引き続き注意が必要だ。確実な数字は6月25日の公式発表で更新する。

---

*注記：本記事は2026年6月22日時点の情報にもとづく。確定事項はRockstar Gamesおよびニュースワイヤーの公式発表に準拠し、価格・エディションに関する記述は現時点では未確認の観測・推測を含む。6月25日の正式発表後に内容を更新する。*`,
  },
  {
    id: 11,
...
しかしLEONIDA GATEが各所の情報を確認したところ、これらは厳密には「リーク」ではない。2026年6月時点でPC版GTA6は公式に発表すらされておらず、当然ながらシステム要件の公式スペック表も存在しない。出回っている数字の正体は、コンソールのハードウェア構成や過去のRockstar作品から逆算したコミュニティ・ハードウェア解析筋の「予測」である。本記事は、確定している事実と、推測にすぎない部分をはっきり切り分けて整理する。
...
数字に幅があるとはいえ、各予測が「高性能PCが必要になる」という方向で一致しているのには理由がある。LEONIDA GATEが整理したポイントは次の通り。
...
そこでLEONIDA GATEでは、公開済みのトレーラーで実際に示された要素、2022年に流出した開発初期ビルドの映像、そして過去作（特にレッド・デッド・リデンプション2）の傾向という三つの手がかりから、ゲームプレイ機能の方向性を整理した。本記事はあくまで現時点の材料にもとづく考察であり、確定情報ではない点を最初に断っておく。本記事は2026年6月22日時点の情報にもとづく。
