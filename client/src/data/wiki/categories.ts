...
export const WIKI_CATEGORIES: WikiCategory[] = [
  {
    ...
    description:
      'GTA6の主人公ルシア・カミノスとジェイソン・デュヴァル、公式バイオが公開された主要キャラクター、トレーラーや取材で判明した登場人物を確度ラベル付きで整理。声優は未発表です。',
    order: 1,
    accent: '#ff2d95',
  ...
  },
  {
    ...
    description:
      'GTA6の舞台レオニダ州の地理を地域単位で整理。公式確定の6大地域（バイスシティ・グラスリバーズ・レオニダキーズほか）、郡区分の扱い、マップの規模、地形・天候を確度ラベル付きで解説。',
    order: 2,
    accent: '#2de2e6',
  ...
  },
  {
    ...
    description:
      'GTA6のトレーラー・公式素材で確認された建物・店舗・ランドマークを地域別に整理。名称が確認されたものと、噂・ファン呼称のものを確度ラベルで区別しています。セーフハウスや拠点もまとめて掲載。',
    order: 3,
    accent: '#ff8a3d',
