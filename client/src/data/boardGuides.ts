...
export const BOARD_GUIDES: Record<BoardGuideKey, { ja: BoardGuideContent; en: BoardGuideContent }> = {
  ...
  friends: {
    ja: {
      lead: 'フレンド募集掲示板は、GTA6 / GTAオンラインを一緒に遊ぶ相手を探すためのカード型の募集板です。プラットフォームと遊びかたで絞り込めるようになっています。',
      sections: [
        {
          heading: '募集の書きかた',
          body: [
  ...
  crews: {
    ja: {
      lead: 'クルー募集掲示板は、GTA6 / GTAオンラインのクルー（チーム）がメンバーを募集したり、入るクルーを探したりするためのカード型の募集板です。',
      sections: [
        {
          heading: 'クルーを募集する場合',
          body: [
