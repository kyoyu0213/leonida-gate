...
const devDiary1: FieldNote = {
  ...
  image: '/images/taikenki/serverkaihatu/1/spawn.webp',
  icon: '📓',
  ...
  body: `![チュマシュのAmmunation前に立つ自作キャラクター。左上に「IcyToad5630 joined.」の表示](/images/taikenki/serverkaihatu/1/spawn.webp)
...
![サーバーに接続した直後のマップ画面。ストロベリー付近にキャラクターがいる](/images/taikenki/serverkaihatu/1/map.webp)
...
この記事はGTA6 FEED運営者が、自分のPCで実際にFiveMサーバーを構築した記録である。技術的な情報は2026年5月時点の公式ドキュメントおよび各ツールの提供内容を確認して記載しているが、仕様や無料枠の内容は今後変わる可能性がある。FiveMおよびGTAは、それぞれの権利者（Cfx.re / Rockstar Games）の商標であり、本サイトは各社と提携関係にない。`,
  bodyEn: `![My own character standing in front of the Chumash Ammunation, with "IcyToad5630 joined." shown at top-left](/images/taikenki/serverkaihatu/1/spawn.webp)
...
![The map screen right after connecting to the server, with a character near Strawberry](/images/taikenki/serverkaihatu/1/map.webp)
...
const devDiary2: FieldNote = {
  ...
  image: '/images/taikenki/serverkaihatu/2/image.webp',
  icon: '📓',
  ...
  body: `![レジオンスクエアに固定スポーンした、見た目も固定済みの自作キャラクター](/images/taikenki/serverkaihatu/2/image.webp)
...
![VSCode上でClaude CodeがFiveM用のLuaスクリプト（simple_respawn）を生成している画面](/images/taikenki/serverkaihatu/2/image3_masked.webp)
...
![AIに書いてもらった fixed_spawn・simple_character・simple_respawn などのリソースを resources フォルダに配置したところ（vMenu も導入済み）](/images/taikenki/serverkaihatu/2/image2.webp)
...
この記事はGTA6 FEED運営者が、自分のPCで実際にFiveMサーバーを構築している記録である。技術的な情報は2026年5月時点の公式ドキュメントおよび各ツールの提供内容を確認して記載しているが、仕様や難易度は環境によって異なり、今後変わる可能性がある。FiveMおよびGTAは、それぞれの権利者（Cfx.re / Rockstar Games）の商標であり、本サイトは各社と提携関係にない。`,
  bodyEn: `![My own character with a fixed appearance, fixed-spawned at Legion Square](/images/taikenki/serverkaihatu/2/image.webp)
...
![Claude Code in VSCode generating a Lua script (simple_respawn) for FiveM](/images/taikenki/serverkaihatu/2/image3_masked.webp)
...
![The AI-written resources — fixed_spawn, simple_character, simple_respawn and more — placed in the resources folder (vMenu is installed too)](/images/taikenki/serverkaihatu/2/image2.webp)
...
const devDiary3: FieldNote = {
  ...
  image: '/images/taikenki/serverkaihatu/3/hero.webp',
  icon: '📓',
  seoTitle:
  ...
  body: `![夕暮れのダウンタウン（レジオンスクエア付近）に立つ、見た目を固定した自作キャラクター](/images/taikenki/serverkaihatu/3/hero.webp)
...
![/charmenu で開いた simple_character の編集メニュー。Ped Model・Face・Hair・Torso などの項目と「SAVE & CLOSE」が並ぶ](/images/taikenki/serverkaihatu/3/charmenu.webp)
...
![路上で死亡し、リスポーン待ちになった自作キャラクター](/images/taikenki/serverkaihatu/3/death.webp)
...
![復活直後の画面。左下にvMenu由来の「保存済みキャラクターが未設定」という警告と「IcyToad5630 died.」が表示されている](/images/taikenki/serverkaihatu/3/respawn.webp)
...
![VS Code の Claude Code に「DEVLOG.md を新規作成」と指示し、24行のDEVLOG.mdが生成された画面](/images/taikenki/serverkaihatu/3/devlog.webp)
...
この記事はGTA6 FEED運営者が、自分のPCで実際にFiveMサーバーを構築している記録である。技術的な情報は2026年6月時点の環境と各ツールの提供内容を確認して記載しているが、仕様や挙動は環境によって異なり、今後変わる可能性がある。FiveMおよびGTAは、それぞれの権利者（Cfx.re / Rockstar Games）の商標であり、本サイトは各社と提携関係にない。`,
  bodyEn: `![My own character, with a fixed appearance, standing in downtown (near Legion Square) at dusk](/images/taikenki/serverkaihatu/3/hero.webp)
...
![The simple_character edit menu opened with /charmenu — items like Ped Model, Face, Hair, and Torso, with "SAVE & CLOSE" listed](/images/taikenki/serverkaihatu/3/charmenu.webp)
...
![My own character down on the road, waiting to respawn](/images/taikenki/serverkaihatu/3/death.webp)
...
![The screen right after reviving. At the bottom-left, a vMenu warning that "no saved character is set" and "IcyToad5630 died." are shown](/images/taikenki/serverkaihatu/3/respawn.webp)
...
![The Claude Code screen in VS Code after instructing it to "create a new DEVLOG.md," generating a 24-line DEVLOG.md](/images/taikenki/serverkaihatu/3/devlog.webp)
...
const devDiary4: FieldNote = {
  ...
  image: '/images/taikenki/serverkaihatu/4/hero.webp',
  icon: '📓',
  seoTitle:
  ...
  body: `![夕暮れのグランド・セノーラ砂漠の丘に立つ自作キャラクター。周囲には木と地面だけが広がっている](/images/taikenki/serverkaihatu/4/hero.webp)
...
![txAdminのコンソールで refresh と ensure route68house を実行し、「Started resource route68house」と表示された画面](/images/taikenki/serverkaihatu/4/route68house-start.webp)

## 開発用テレポート機能を追加

MLO の確認をするには、まずその座標まで移動しないと話にならない。毎回歩いたり車で向かうのは非効率なので、開発効率を上げるために新しく simple_teleport を自作した。

![ゲーム内で開いた vMenu の MAIN MENU。Online Players、Player Related Options、Vehicle Related Options などの項目が並ぶ](/images/taikenki/serverkaihatu/4/vmenu.webp)
...
![txAdminのコンソールで ensure simple_teleport を実行し、「Started resource simple_teleport」と表示された画面](/images/taikenki/serverkaihatu/4/simple-teleport-start.webp)
...
![ゲーム内チャットに /tp と入力したときのヘルプ表示。「/tp [x] [y] [z] 指定した座標へテレポートします」と表示されている](/images/taikenki/serverkaihatu/4/tp-help.webp)
...
![テレポート先の丘の斜面。建物は表示されておらず、倒れ込んだ自作キャラクターと草地・岩肌だけが見える](/images/taikenki/serverkaihatu/4/route68house-empty.webp)
...
この記事はGTA6 FEED運営者が、自分のPCで実際にFiveMサーバーを構築している記録である。技術的な情報は2026年6月時点の環境と各ツールの提供内容を確認して記載しているが、仕様や挙動は環境によって異なり、今後変わる可能性がある。FiveMおよびGTAは、それぞれの権利者（Cfx.re / Rockstar Games）の商標であり、本サイトは各社と提携関係にない。`,
  bodyEn: `![My own character standing on a hill in the Grand Senora Desert at dusk, with nothing around but trees and bare ground](/images/taikenki/serverkaihatu/4/hero.webp)
...
![The txAdmin console after running refresh and ensure route68house, showing "Started resource route68house"](/images/taikenki/serverkaihatu/4/route68house-start.webp)
...
![The vMenu MAIN MENU opened in game, listing items like Online Players, Player Related Options, and Vehicle Related Options](/images/taikenki/serverkaihatu/4/vmenu.webp)
...
![The txAdmin console after running ensure simple_teleport, showing "Started resource simple_teleport"](/images/taikenki/serverkaihatu/4/simple-teleport-start.webp)
...
![The help shown in the in-game chat when typing /tp: "/tp [x] [y] [z] teleports you to the specified coordinates"](/images/taikenki/serverkaihatu/4/tp-help.webp)
...
![The hillside at the teleport destination. No building is rendered — only my own character collapsed on the slope, grass, and bare rock](/images/taikenki/serverkaihatu/4/route68house-empty.webp)
...
const heliosCity: FieldNote = {
  ...
  image: '/images/taikenki/serverhoumon/HeliosCity/eyecatch.webp',
  icon: '📍',
  ...
  body: `![HeliosCityの街を流すタクシー（Downtown Cab Co）。奥はメカニック「West Coast Garage」](/images/taikenki/serverhoumon/HeliosCity/eyecatch.webp)
...
![HeliosCityの全体マップ。カジノ・ガレージ・北署／南署・素材屋（月兎屋）・飲食店（料亭よひら）・ストレス軽減店（千葉たばこ店）などの施設マーカーが並ぶ](/images/taikenki/serverhoumon/HeliosCity/map.webp)

## 街の雰囲気

初訪問時、街の各所に多数のプレイヤーがおり、複数の店舗で人の出入りが見られた。プレイヤーの服装・髪型のバリエーションは幅広く、キャラメイクの作り込みに個人差が出ていた。遅い時間帯でも飲食店が営業していた。

![夜、ドレス姿など思い思いの服装で集まるプレイヤーたち](/images/taikenki/serverhoumon/HeliosCity/nightlife.webp)

マップのベースはGTA5のバニラ（ロスサントス）に近いが、メカニックや病院などの施設にはMLO（カスタム内装）が導入されている。

![深夜営業の飲食店「BAR Arcana」の深夜限定メニュー（23:00〜27:00）](/images/taikenki/serverhoumon/HeliosCity/cafe-menu.webp)
...
![ジョブセンターの申請画面。清掃員・記者・ホットドッグ屋台・運送・タクシー・レッカー・バス運転手の7職種が並ぶ](/images/taikenki/serverhoumon/HeliosCity/jobcenter.webp)
...
![タクシージョブ中の画面。運賃メーターが表示され、乗客ミッションが進行している](/images/taikenki/serverhoumon/HeliosCity/taxi-job.webp)
...
![スマホの「会社」アプリ。Police・Ambulance・Mechanic・Taxi が稼働先として表示されている](/images/taikenki/serverhoumon/HeliosCity/phone-companies.webp)
...
![犯罪コンテンツの一覧パネル。小型〜超大型の強盗が並び、上部にオンデューティのPD2人・EMS1人と同接32/200が表示されている](/images/taikenki/serverhoumon/HeliosCity/crime.webp)
...
![HELIOSブランドの商品が並ぶショップ（HELIOSサンド・コーヒー・キャンディ、無線機、IFAK、ダイビングギアなど）](/images/taikenki/serverhoumon/HeliosCity/shop.webp)

設備が存在することと、それが経済として回っているかは別の話であり、後者は継続的にプレイしないと判断できない領域になる。

## 六法・ルールの特徴

![シティホール内の裁判所エリア。COURT CASES／CRIMINAL RECORDS／COURT ROOM の案内が見える](/images/taikenki/serverhoumon/HeliosCity/courthouse.webp)
...
![RCORE系のキャラメイク画面。顔の遺伝や肌の色などを細かく調整できる](/images/taikenki/serverhoumon/HeliosCity/charactercreate.webp)
...
本記事はGTA6 FEEDが独自に取材・記録したものであり、HeliosCity運営、Rockstar Games、Take-Two Interactiveのいずれとも関係はない。記載内容は初訪問時点の情報であり、サーバーの仕様・ルールは変更される可能性がある。`,
  bodyEn: `![A taxi (Downtown Cab Co) cruising through HeliosCity, with the "West Coast Garage" mechanic shop behind it](/images/taikenki/serverhoumon/HeliosCity/eyecatch.webp)
...
![The full map of HeliosCity, dotted with facility markers — casino, garages, north/south police stations, the material shop (Getsutoya), a restaurant (Ryotei Yohira), and a stress-relief shop (Chiba Tobacco)](/images/taikenki/serverhoumon/HeliosCity/map.webp)
...
![At night, players gathered in outfits of their own choosing, including in dresses](/images/taikenki/serverhoumon/HeliosCity/nightlife.webp)
...
![The late-night limited menu (23:00–27:00) of the restaurant "BAR Arcana," open into the small hours](/images/taikenki/serverhoumon/HeliosCity/cafe-menu.webp)
...
![The Job Center application screen, listing the seven jobs: Garbage Collector, News Reporter, Hot Dog Stand, Trucker, Taxi, Tow Truck, and Bus Driver](/images/taikenki/serverhoumon/HeliosCity/jobcenter.webp)
...
![The screen during the taxi job, with the fare meter displayed and a passenger mission in progress](/images/taikenki/serverhoumon/HeliosCity/taxi-job.webp)
...
![The phone's "Companies" app, showing Police, Ambulance, Mechanic, and Taxi as workplaces](/images/taikenki/serverhoumon/HeliosCity/phone-companies.webp)
...
![The crime-content list panel: heists ranging from small to super-large are listed, with 2 PD and 1 EMS on duty and 32/200 concurrent shown at the top](/images/taikenki/serverhoumon/HeliosCity/crime.webp)
...
![A shop lined with HELIOS-branded goods (HELIOS sandwich, coffee, and candy, plus a radio, IFAK, diving gear, and more)](/images/taikenki/serverhoumon/HeliosCity/shop.webp)
...
![The courthouse area inside City Hall, with signs for COURT CASES, CRIMINAL RECORDS, and COURT ROOM visible](/images/taikenki/serverhoumon/HeliosCity/courthouse.webp)
...
![An RCORE-style character creation screen, where you can finely adjust facial genetics, skin color, and more](/images/taikenki/serverhoumon/HeliosCity/charactercreate.webp)
...
const refloriaTown: FieldNote = {
  ...
  image: '/images/taikenki/serverhoumon/RefloriaTown/matinoyousu.webp',
  icon: '📍',
  seoTitle:
  ...
  body: `![山の上、本来バインウッド看板がある位置に掲げられたRefloria Townのロゴ看板。右上には「指名手配終了」の通知が流れている](/images/taikenki/serverhoumon/RefloriaTown/matinoyousu.webp)
...
![桜並木の向こうに広がる街並み。「Auto Exotic」の大型施設が通り沿いに建つ](/images/taikenki/serverhoumon/RefloriaTown/dealer.webp)
...
![高架の下に整備されたMLOのエリア。STOP標識のゲートや店舗が並ぶ](/images/taikenki/serverhoumon/RefloriaTown/mechanic.webp)
...
![市役所の内装。大理石の階段と、MAYOR OFFICE／MEETING ROOM／VOTING ROOM／OFFICESへの案内板が見える（506番地）](/images/taikenki/serverhoumon/RefloriaTown/siyakusyojob.webp)
...
![職業センターの応募メニュー。ホットドッグ屋・ゴミ収集作業員・バスの運転手・農家・タクシーが並び、その場で応募できる](/images/taikenki/serverhoumon/RefloriaTown/siyakusyojob2.webp)
...
![ペットショップのシチュエーションボイス販売広告。「ペットショップのボイス」CV：とあるペットショップ店員、収録時間00:40](/images/taikenki/serverhoumon/RefloriaTown/boisuhanbai.webp)
...
![リーフ薬局（Leaf Pharmacy）のメニュー。絆創膏¥13,000ほか、品目ごとの価格と回復量が並ぶ（577番地）](/images/taikenki/serverhoumon/RefloriaTown/yakkyokumenyu.webp)
...
![和風店「庵椿」のおしながき。椿印のお饅頭40%、天ぷらうどん30%、三色団子25%、抹茶15%など、体力回復率つきで並ぶ](/images/taikenki/serverhoumon/RefloriaTown/insyokumenyu9.webp)

季節に応じた限定メニューも用意されており、七夕の時期には七夕スイーツプレート（¥15,000・食料50%回復）と星空カクテル（¥15,000・水分50%回復）が提供されていた。

![七夕スペシャルメニュー。七夕スイーツプレート（食料50%・¥15,000）と星空カクテル（水分50%・¥15,000）](/images/taikenki/serverhoumon/RefloriaTown/insyokumenyu0.webp)
...
![マップ上に色分け表示されたギャングのテリトリー。ロスサントス市街地を中心に赤・紫・黄・緑などの区画が分かれ、右側にランドマーク一覧（17/109）が表示されている](/images/taikenki/serverhoumon/RefloriaTown/gyanguiro.webp)
...
![リサイクルルームの選択画面。ルームA（誰でも何人でも入れる共有部屋）からルームK（利用人数1/5・パスワード付き）までが並ぶ](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter4.webp)

作業の流れは、ルームに入り、心の目（インタラクト操作）で素材を回収し、これを運んで奥にいるNPCに渡すとリサイクルボックスと交換できる。このリサイクルボックスを使用すると、中身が排出される仕組みになっている。

![リサセンの倉庫内部。奥にNPCが立ち、右上に「リサイクル Lv1/30・XP86/300・作業+200」の進行表示がある](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter.webp)

![木箱を「検索中（59%）」で調べているところ。心の目で素材を回収する作業の様子](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter2.webp)

![奥のNPCの「素材交換」メニュー。1素材・10素材・50素材・100素材の交換が並ぶ](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter3.webp)

![所持品内のリサイクルボックス（200g 2x）。使用すると中身が排出される](/images/taikenki/serverhoumon/RefloriaTown/recyclebox.webp)
...
![パレトの森の道路脇で弓を構えたところ。画面左に「0/1」の進行カウンタが表示されている](/images/taikenki/serverhoumon/RefloriaTown/kari.webp)

![弓のスコープを覗き、森の中の動物を狙っている画面。距離目盛りと「0/1」カウンタが見える](/images/taikenki/serverhoumon/RefloriaTown/kari2.webp)

仕留めた動物は食肉加工場に持ち込む。加工場はパレト湾（3013番地）にあり、NPCに渡すことで食肉に加工される。これを売却して収益とする流れになる。

![パレト湾（3013番地）の食肉加工場。搬入口の前にエプロン姿のNPCが立つ](/images/taikenki/serverhoumon/RefloriaTown/syokunikukakou.webp)
...
![bincoのキャラメイク「遺伝」画面。父（ID:21）と母（ID:33）の顔を選び、ブレンドスライダーで似せ具合を調整する。左には遺伝・顔の特徴・髪型・肌の欠点などの項目が並ぶ](/images/taikenki/serverhoumon/RefloriaTown/kyarameiku.webp)
...
本記事はGTA6 FEEDが独自に取材・記録したものであり、Refloria Town運営、Rockstar Games、Take-Two Interactiveのいずれとも関係はない。記載内容は取材時点の情報であり、サーバーの仕様・ルールは変更される可能性がある。`,
  bodyEn: `![Refloria Town's logo sign raised on the mountaintop where the Vinewood sign would normally be. At the top right, a "wanted status ended" notification is showing](/images/taikenki/serverhoumon/RefloriaTown/matinoyousu.webp)
...
![A cityscape spreading out beyond a row of cherry-blossom trees, with the large "Auto Exotic" facility standing along the street](/images/taikenki/serverhoumon/RefloriaTown/dealer.webp)
...
![An MLO area laid out beneath an overpass, lined with a STOP-sign gate and shops](/images/taikenki/serverhoumon/RefloriaTown/mechanic.webp)
...
![The interior of City Hall. A marble staircase, and a signboard pointing to MAYOR OFFICE / MEETING ROOM / VOTING ROOM / OFFICES (address 506)](/images/taikenki/serverhoumon/RefloriaTown/siyakusyojob.webp)
...
![The Job Center application menu, listing hot dog vendor, garbage collector, bus driver, farmer, and taxi — all of which you can apply for on the spot](/images/taikenki/serverhoumon/RefloriaTown/siyakusyojob2.webp)
...
![An ad for situation voice recordings sold at the pet shop: "Pet Shop Voice," CV: a certain pet shop clerk, running time 00:40](/images/taikenki/serverhoumon/RefloriaTown/boisuhanbai.webp)
...
![The Leaf Pharmacy menu. Bandage ¥13,000 and others, with the price and recovery amount listed per item (address 577)](/images/taikenki/serverhoumon/RefloriaTown/yakkyokumenyu.webp)
...
![The menu at the Japanese-style shop "Antsubaki." Tsubaki-brand manju 40%, tempura udon 30%, tricolor dango 25%, matcha 15%, and more, each with a health-recovery rate](/images/taikenki/serverhoumon/RefloriaTown/insyokumenyu9.webp)
...
![The Tanabata special menu. Tanabata Sweets Plate (50% food, ¥15,000) and Starry Sky Cocktail (50% hydration, ¥15,000)](/images/taikenki/serverhoumon/RefloriaTown/insyokumenyu0.webp)
...
![Gang territories displayed color-coded on the map. Districts in red, purple, yellow, green, and more are divided mainly around downtown Los Santos, with a landmark list (17/109) shown on the right](/images/taikenki/serverhoumon/RefloriaTown/gyanguiro.webp)
...
![The recycling-room selection screen. Rooms range from Room A (a shared room anyone in any number can enter) to Room K (1/5 users, password-protected)](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter4.webp)
...
![The interior of the recycling center's warehouse. An NPC stands at the back, and the top right shows the progress display "Recycle Lv1/30, XP86/300, work +200"](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter.webp)

![Examining a wooden crate at "searching (59%)." The scene of gathering materials with the mind's eye](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter2.webp)

![The "material exchange" menu of the NPC at the back, listing exchanges of 1, 10, 50, and 100 materials](/images/taikenki/serverhoumon/RefloriaTown/recyclecenter3.webp)

![A recycle box (200g 2x) in the inventory. Using it dispenses the contents](/images/taikenki/serverhoumon/RefloriaTown/recyclebox.webp)
...
![Taking aim with a bow at the roadside in the Paleto Forest. A "0/1" progress counter is shown on the left of the screen](/images/taikenki/serverhoumon/RefloriaTown/kari.webp)

![Looking through the bow's scope to aim at an animal in the forest. The distance scale and the "0/1" counter are visible](/images/taikenki/serverhoumon/RefloriaTown/kari2.webp)
...
![The meat-processing plant in Paleto Bay (address 3013). An NPC in an apron stands in front of the loading entrance](/images/taikenki/serverhoumon/RefloriaTown/syokunikukakou.webp)
...
![Binco's "genetics" character-creation screen. You select the father (ID:21) and mother (ID:33) faces and adjust the resemblance with a blend slider. On the left are items such as genetics, facial features, hairstyle, and skin imperfections](/images/taikenki/serverhoumon/RefloriaTown/kyarameiku.webp)
...
const lienCity: FieldNote = {
  ...
  image: '/images/taikenki/serverhoumon/Liencity/insyokuten.webp',
  icon: '📍',
  ...
  body: `![夕暮れのLien City。バンブーの柱と2階テラスを備えた飲食店「Johnny's Bar」が通り沿いに建つ](/images/taikenki/serverhoumon/Liencity/insyokuten.webp)
...
![Lien Cityの全体マップ。右側にアラモ湖アウトフィッターズ・各種釣具店／魚市場・本署・ガレージ・Bank・Barber・Clothing Store・Recycle Centerなどのランドマーク一覧（1/49）が並ぶ](/images/taikenki/serverhoumon/Liencity/map.webp)

## 街の雰囲気

服飾の選択肢が多く、プレイヤーの服装にばらつきが見られた。

![服装のカスタマイズ画面。スカーフ・チェーン、ジャケット（15/2036）、シャツ（14/1044）、ボディアーマー、バッグ・パラシュート、腕・手、脚、靴、デカールなど部位ごとに多数のDrawableを選択できる](/images/taikenki/serverhoumon/Liencity/kyarameikugamen.webp)
...
![市役所の求人センター。ゴミ収集員・タクシー運転手・ホットドッグ屋台の3職種が並び、それぞれ「この職に応募する」と表示されている](/images/taikenki/serverhoumon/Liencity/siyakusyojob.webp)

飲食店は4店舗、たばこ屋を1店舗確認した。メカニックは3か所。車両ディーラーは普通車と高級車が分かれており、航空機ディーラーも存在する。

![夕暮れの車両ディーラー「Premium Deluxe Motorsport」の外観](/images/taikenki/serverhoumon/Liencity/dealer2.webp)

![コンビニの商品一覧。ハンバーガー ¥100,000、飲料水 ¥100,000、無線機 ¥380、FITBIT ¥320、SKATEBOARD ¥50,000、ブームボックス ¥30,000、衣装バッグ、タバコが並ぶ](/images/taikenki/serverhoumon/Liencity/konbinidekaerumono.webp)
...
![銀行「OKOK BANKING」の設定画面。口座番号の変更（手数料¥200・口座番号は「OK」で始まる・最大10文字）と暗証番号の変更（手数料¥200・4文字・数字のみ）が並ぶ](/images/taikenki/serverhoumon/Liencity/ginkoukouza.webp)

取材では、ディーラーに勧められた車両を600万円で購入した。

![普通車ディーラーの購入画面。SUV HABANERO 6,000,000¥ に対し「SUV Habanero を 6,000,000¥ で購入しますか？」の確認ダイアログが表示されている](/images/taikenki/serverhoumon/Liencity/dealer.webp)
...
![救助要請の画面表示。「EMS 1名 / 個人医 3名」「[R]…… 個人医へ救助信号（長押し）」「EMSへ送信済み（再送 04分05秒）」と表示されている](/images/taikenki/serverhoumon/Liencity/EMSwoyobu.webp)
...
![渓谷の川で作業する複数のプレイヤー。5017番地付近の砂金採りポイント](/images/taikenki/serverhoumon/Liencity/sakintori.webp)
...
![夜の採石場（Davis Quartz、3054番地付近）。岩壁沿いに重機が停まっている](/images/taikenki/serverhoumon/Liencity/saisekijyo.webp)

![坑内でドリルを使って採掘しているところ。画面下に「採掘中…」の進行バーが表示されている](/images/taikenki/serverhoumon/Liencity/mainingu.webp)

![採掘の結果、「添加 2X STONE」として石を入手した表示](/images/taikenki/serverhoumon/Liencity/isigahoreta.webp)

作業の特徴は、各工程がまとめて処理できる点にある。採取した石は一括で洗浄できる。砂金採りも宝石加工も同様にまとめて処理できる。

![水辺で「石を洗う（この水辺の範囲内）」を実行しているところ。画面下に「洗石中… x20」の進行バーが表示されている（7352番地付近）](/images/taikenki/serverhoumon/Liencity/isiarai.webp)

![「一括処理の個数」ダイアログ。個数（最大20）のスライダーが20に設定されている](/images/taikenki/serverhoumon/Liencity/matometetoreru.webp)

![川で砂金採りをする2人のプレイヤー。画面下に「砂金採り中… x20」の進行バーが表示されている（5017番地）](/images/taikenki/serverhoumon/Liencity/sakinori2.webp)

なお、砂金採りを終えた時点でインベントリを確認すると石が残っており、所持重量を圧迫していた。このため別地点で再度洗浄する必要が生じた。

![インベントリの中身。UNCUT DIAMOND 44x、UNCUT EMERALD 25x、UNCUT SAPPHIRE 66x、UNCUT RUBY 79x、SILVER ORE 50x、GOLD ORE 41x、GOLD INGOT、EMERALD 28x、ガラス、ドリルビットなどが並ぶ](/images/taikenki/serverhoumon/Liencity/jewel.webp)

工程を一巡させ、指輪の製作に至るまでに5時間30分を要した。

![「DANGER HIGH TEMPERATURE AREA」の看板が立つ溶鉱炉エリア。複数のプレイヤーが作業している（9306番地付近）](/images/taikenki/serverhoumon/Liencity/youkouro.webp)

![宝石加工の工房。複数のプレイヤーが作業台に並び、画面下に「加工中 Emerald Ring (Silver) x20」の進行バーが表示されている](/images/taikenki/serverhoumon/Liencity/housekikakou.webp)

完成した指輪を質屋に持ち込んだところ、買い取り対象となったのはダイヤモンドリングのみだった。ダイヤモンドリング以外の指輪は、加工に時間を要したものの売却先が見つからなかった。

![質屋の買い取り画面。「Diamond Ring 売却価格 $200000」のみが表示されている](/images/taikenki/serverhoumon/Liencity/sitiya.webp)

ダイヤモンドリングは50個を売却し、1000万円となった。

![質屋のメニュー（アイテムを売る／アイテムを溶解）。画面右上の所持金が ¥10074975 と表示されている](/images/taikenki/serverhoumon/Liencity/sitiya2.webp)
...
本記事はGTA6 FEEDが独自に取材・記録したものであり、Lien City運営、Rockstar Games、Take-Two Interactiveのいずれとも関係はない。記載内容は取材時点の情報であり、サーバーの仕様・ルールは変更される可能性がある。`,
  bodyEn: `![Lien City at dusk. The restaurant "Johnny's Bar," with bamboo columns and a second-floor terrace, stands along the street](/images/taikenki/serverhoumon/Liencity/insyokuten.webp)
...
![The full map of Lien City. On the right is a landmark list (1/49) including Alamo Lake Outfitters, various tackle shops and fish markets, the main police station, garages, Bank, Barber, Clothing Store, and Recycle Center](/images/taikenki/serverhoumon/Liencity/map.webp)

## The Feel of the City

There are many clothing options, and variation was visible in players' outfits.

![The clothing customization screen. Numerous drawables can be selected per body part — scarf/chain, jacket (15/2036), shirt (14/1044), body armor, bag/parachute, arms/hands, legs, shoes, and decals](/images/taikenki/serverhoumon/Liencity/kyarameikugamen.webp)
...
![The job center at City Hall. Three roles are listed — garbage collector, taxi driver, and hot dog stand — each showing "apply for this job"](/images/taikenki/serverhoumon/Liencity/siyakusyojob.webp)
...
![The exterior of the vehicle dealer "Premium Deluxe Motorsport" at dusk](/images/taikenki/serverhoumon/Liencity/dealer2.webp)

![The convenience store's product list. Hamburger ¥100,000, drinking water ¥100,000, radio ¥380, FITBIT ¥320, SKATEBOARD ¥50,000, boombox ¥30,000, clothing bag, and cigarettes](/images/taikenki/serverhoumon/Liencity/konbinidekaerumono.webp)
...
![The settings screen of the bank "OKOK BANKING." Changing the account number (¥200 fee, account numbers start with "OK," max 10 characters) and changing the PIN (¥200 fee, 4 characters, digits only)](/images/taikenki/serverhoumon/Liencity/ginkoukouza.webp)

During our visit, I bought the vehicle recommended by the dealer for 6 million yen.

![The purchase screen at the standard car dealer. Against the SUV HABANERO at 6,000,000¥, a confirmation dialog asks "Purchase the SUV Habanero for 6,000,000¥?"](/images/taikenki/serverhoumon/Liencity/dealer.webp)
...
![The rescue-request display. It shows "EMS: 1 / private doctors: 3," "[R]…… rescue signal to a private doctor (hold)," and "Sent to EMS (resend in 04:05)"](/images/taikenki/serverhoumon/Liencity/EMSwoyobu.webp)
...
![Several players working in a canyon river. The gold-panning point near address 5017](/images/taikenki/serverhoumon/Liencity/sakintori.webp)
...
![The quarry at night (Davis Quartz, near address 3054). Heavy machinery is parked along the rock face](/images/taikenki/serverhoumon/Liencity/saisekijyo.webp)

![Mining with a drill inside the pit. A "mining…" progress bar is shown at the bottom of the screen](/images/taikenki/serverhoumon/Liencity/mainingu.webp)

![The result of mining: a display showing stone obtained as "added 2X STONE"](/images/taikenki/serverhoumon/Liencity/isigahoreta.webp)
...
![Executing "wash stones (within this waterside area)" at the water's edge. A "washing stones… x20" progress bar is shown at the bottom of the screen (near address 7352)](/images/taikenki/serverhoumon/Liencity/isiarai.webp)

![The "bulk processing quantity" dialog. The quantity slider (max 20) is set to 20](/images/taikenki/serverhoumon/Liencity/matometetoreru.webp)

![Two players panning for gold in the river. A "panning for gold… x20" progress bar is shown at the bottom of the screen (address 5017)](/images/taikenki/serverhoumon/Liencity/sakinori2.webp)
...
![The contents of the inventory. UNCUT DIAMOND 44x, UNCUT EMERALD 25x, UNCUT SAPPHIRE 66x, UNCUT RUBY 79x, SILVER ORE 50x, GOLD ORE 41x, GOLD INGOT, EMERALD 28x, glass, drill bits, and more](/images/taikenki/serverhoumon/Liencity/jewel.webp)

Running the pipeline through one full cycle, it took 5 hours and 30 minutes to reach the production of rings.

![The smelting-furnace area with a "DANGER HIGH TEMPERATURE AREA" sign. Several players are at work (near address 9306)](/images/taikenki/serverhoumon/Liencity/youkouro.webp)

![The gem-processing workshop. Several players line up at the workbenches, and a "processing Emerald Ring (Silver) x20" progress bar is shown at the bottom of the screen](/images/taikenki/serverhoumon/Liencity/housekikakou.webp)
...
![The pawn shop's buyback screen. Only "Diamond Ring, sale price $200000" is displayed](/images/taikenki/serverhoumon/Liencity/sitiya.webp)

I sold 50 diamond rings, which came to 10 million yen.

![The pawn shop menu (sell items / melt down items). The cash on hand at the top right shows ¥10074975](/images/taikenki/serverhoumon/Liencity/sitiya2.webp)
