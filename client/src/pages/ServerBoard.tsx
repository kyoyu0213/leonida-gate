      ...
      <main className="max-w-[1320px] mx-auto px-4 sm:px-6 lg:px-[30px] pt-[100px] pb-16 relative z-10">
        ...
        <div className="flex items-end justify-between gap-5 flex-wrap mb-2">
          <div>
            ...
            {/* jp-head: 「住民募集板」など日本語を途中で改行させず、スペース位置で折り返す（サイト固定見出し用） */}
            <h1 className="font-black text-3xl md:text-[46px] leading-tight mt-2 jp-head">{tr('srv.heading')}</h1>
        ...
        {/* サーバー一覧はクライアント取得のため、生HTMLに実コンテンツを残すのはこのブロック。 */}
