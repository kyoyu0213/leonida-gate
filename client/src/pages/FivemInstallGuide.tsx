...
![FiveM公式サイト](/images/FiveMhajimekata/FiveMofficial.webp)
...
![GTA5 Legacy Edition（Steamの例）](/images/FiveMhajimekata/GTA5Legacyedition.webp)
...
![ダウンロードしたFiveM.exe](/images/FiveMhajimekata/FiveMexe.webp)
...
![FiveMのインストール](/images/FiveMhajimekata/install.webp)
...
![デスクトップに作成されたショートカット](/images/FiveMhajimekata/desktopicon.webp)

**手順6：起動が済むとサーバーブラウザが表示される。**
ここから遊びたいサーバーを選んで接続する。サーバーによってはDiscord連携や審査が必要な場合もある。

![FiveMのサーバーブラウザ](/images/FiveMhajimekata/defaultgamen.webp)
...
![The FiveM official site](/images/FiveMhajimekata/FiveMofficial.webp)
...
![GTA5 Legacy Edition (Steam example)](/images/FiveMhajimekata/GTA5Legacyedition.webp)
...
![The downloaded FiveM.exe](/images/FiveMhajimekata/FiveMexe.webp)
...
![Installing FiveM](/images/FiveMhajimekata/install.webp)
...
![The shortcut created on the desktop](/images/FiveMhajimekata/desktopicon.webp)
...
![The FiveM server browser](/images/FiveMhajimekata/defaultgamen.webp)
