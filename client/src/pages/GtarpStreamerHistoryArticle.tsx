...
const BODY = `GTA6時代を前に、日本のGTARP（GTAロールプレイ）は配信文化と結びついて大きく拡大した。きっかけの多くは、ストグラやVCR GTAといった配信者サーバーを配信で見たことだろう。この記事では、GTA6 FEEDが、日本のGTARP配信者サーバーの流れを、公開情報をもとに年表形式で整理した。
...
const TITLE_EN =
  'A History of Japanese GTARP Streamer Servers | A Timeline of Stgra, VCR GTA, Niji GTA, and Holo GTA';

const BODY_EN = `Ahead of the GTA6 era, Japan's GTARP (GTA Roleplay) has expanded greatly in connection with streaming culture. For many, the trigger was watching streamer servers like Stgra and VCR GTA on stream. In this article, GTA6 FEED has organized the flow of Japan's GTARP streamer servers in timeline form, based on publicly available information.
...
| Time | Event | Main Type of Participants |
|---|---|---|
| Aug 2022 | Shobosuke starts a permanent project (originally "Streamer Grand Theft"). Renamed "Street Graffiti Roleplay (Stgra)" in April 2023 | A mix of individuals and corporate talents. Nijisanji members also join |
| Jul 2023 | The first "VCR GTA," a limited-time project hosted by VAULTROOM / Crazy Raccoon, is held | Many major streamers and Nijisanji livers |
...
|---|---|---|
| Stgra | Permanent | Accumulates the life of a single character over the long term |
| VCR GTA | Limited-time event | A "festival" where major streamers gather for an intense short period |
| Niji GTA | Group-exclusive | For Nijisanji livers, about 11 days (June 2024) |
